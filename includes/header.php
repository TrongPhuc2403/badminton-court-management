    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            <?php if ($_SESSION['user']['role'] === 'admin'): ?>
                ...
                <a class="<?= isActiveMenu('/badminton-manager/admin/rewards.php') ?>" href="/badminton-manager/admin/rewards.php">Đổi quà</a>
            ...
            <?php else: ?>
                ...
                <a class="<?= isActiveMenu('/badminton-manager/customer/rewards.php') ?>" href="/badminton-manager/customer/rewards.php">Điểm thưởng</a>
